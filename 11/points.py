...
map.readshapefile('./stockholm/data/3D_Block/sample_files/comarques', 'comarques')

lightning_info = map.readshapefile('./stockholm/data/3D_Block/sample_files/lightnings', 'lightnings')
