...
def fast_iter(context):
    ...
    del context
    util.saveobj(total_ps, '/home/huangby/PycharmProjects/basestudy2/citygml_analysis/citygml_data/obj/building_lod2wall.obj')
...
if __name__ == '__main__':
    ...
    # readzip(path)
    file="/home/huangby/PycharmProjects/basestudy2/citygml_analysis/citygml_data/Berlin_Pariser_Platz_v1.0.0/Berlin_Pariser_Platz_v1.0.0.xml"
    readcity(file)
